        ...
        <ScrollContainer className="flex-1 min-h-0">
          <article className="flex flex-col gap-4">
            ...
            <p>
              ...
              disruptive behavior is strictly prohibited and may result in
              access revocation.
            </p>
            <h2 className="text-xl font-semibold">2. Data Handling</h2>
            <p>
              By submitting the form, you consent to the collection and
              processing of your name, email address, and message for the
              purpose of communication. Your data will be stored securely and
              also forwarded to my personal email inbox.
            </p>
            <p>
            ...
            <p>
              I reserve the right to ignore, delete, or decline to respond to
              any message that is irrelevant, inappropriate, or outside the
              scope of this site's purpose.
            </p>
            <h2 className="text-xl font-semibold">4. Changes to These Terms</h2>
            <p>
              These terms may be updated at any time. The most recent version
