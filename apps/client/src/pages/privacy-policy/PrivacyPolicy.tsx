      ...
      <ScrollContainer className="flex-1 min-h-0">
        <article className="flex flex-col gap-4">
          ...
          <ul className="list-disc list-inside">
            <li>
              <strong>When submitting the contact form:</strong> your name,
              email, and message.
            </li>
            <li>
              <strong>
            ...
            <li>
              <strong>Optional chat or comment content</strong> you send while
              using the chat box or commenting on projects or experiences.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              Authenticate you as a real user (e.g., before you can comment or
              chat)
            </li>
          ...
          <p>
            Contact messages are securely stored in a private database and also
            sent to my personal email address. Login data is used only to create
            or access your user identity on this site. No cookies or analytics
            are used to track your activity.
          </p>

          <h2 className="text-xl font-semibold">4. Your Rights</h2>
          <p>
            You may request access to, correction of, or deletion of your data
            at any time by using the contact form.
          </p>

          <h2 className="text-xl font-semibold">5. Contact</h2>
          <p>
            For any questions about this Privacy Policy or your data, feel free
            to reach out using the contact form.
          </p>

          <h2 className="text-xl font-semibold">6. Data Deletion</h2>
          <p>
            If you signed in with Facebook and would like your account data
            deleted from this website, please visit our{' '}
