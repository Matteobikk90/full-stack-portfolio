      ...
      <section className="flex flex-col flex-1 min-h-0">
        <ScrollContainer className="flex-1 min-h-0">
          <article className="flex flex-col gap-4">
            ...
            <p>
              Contact messages are securely stored in a private database and
              also sent to my personal email address. Login data is used only to
              create or access your user identity on this site. No cookies or
              analytics are used to track your activity.
            </p>
            ...
            <p>
              For any questions about this Privacy Policy or your data, feel
              free to reach out using the contact form.
            </p>
